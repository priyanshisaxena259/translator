...
lab_txt=Label(root,text="Source Text", font=("Times New Roman",20,"bold"), fg='black', bg='lightblue')
...
lab_txt=Label(root,text="Dest Text", font=("Times New Roman",20,"bold"), fg='black', bg='lightblue')
